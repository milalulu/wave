...
import { FolderIcon, HomeIcon, ListIcon, SearchIcon, WaveIcon, PlaylistIcon, SettingsIcon } from "./icons";

export type ViewKey = "home" | "search" | "library" | "queue" | "wave" | "album" | "artist" | "playlist" | "settings";
